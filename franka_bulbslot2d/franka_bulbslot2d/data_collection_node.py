...
class DataCollectionNode(Node):
    def __init__(self):
        super().__init__("bulbslot2d_data_collection")
        defaults = {"control_rate_hz": 20.0, "observation_timeout_s": 0.15,
                    "action_timeout_s": 0.15, "observation_topic": "/bulbslot2d/observation",
                    "executed_action_topic": "/bulbslot2d/executed_action", "dataset_root": "~/bulbslot2d_data"}
        ...
        self.create_service(Trigger, "/bulbslot2d/start_episode", self._start)
        self.create_service(Trigger, "/bulbslot2d/finish_episode", self._finish)
        self.create_service(Trigger, "/bulbslot2d/abort_episode", self._abort)
