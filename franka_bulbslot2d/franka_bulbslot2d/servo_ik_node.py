"""Resolve Cartesian twist into joint velocities the way the bulbscrew_mjx sim does.
...
class ServoIkNode(Node):
    def __init__(self):
        super().__init__("bulbslot2d_servo_ik")
        defaults = {
            "control_rate_hz": 50.0,
            "desired_twist_topic": "/bulbslot2d/desired_twist",
            ...
            # bulbscrew_mjx uses KP_NULL = 0.5 for this term -- much gentler
            # than bulbscrew_mjx's 10.0, because this task moves in 3-D and a hard
            # posture pull fights the vertical carry.
            "nullspace_gain": 0.5,
            # Must track ps5_teleop_node.HOME_JOINTS.
            "nullspace_target": [-0.288396, 0.807440, 0.070228,
                                 -1.160833, -0.054967, 1.966504, 1.963062],
