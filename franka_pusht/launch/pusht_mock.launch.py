...
def generate_launch_description():
    ...
    parameters = [os.path.join(share, "config", "pusht_common.yaml"),
                  os.path.join(share, "config", "pusht_mock.yaml")]
    return LaunchDescription([
        Node(package="franka_pusht", executable="mock_optitrack_node", output="screen"),
        Node(package="franka_pusht", executable="mock_joint_state_node", parameters=parameters, output="screen"),
        Node(package="franka_pusht", executable="observation_node", parameters=parameters, output="screen"),
        Node(package="franka_pusht", executable="teleop_node", parameters=parameters, output="screen"),
