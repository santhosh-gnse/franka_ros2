...
class GripperNode(Node):
    def __init__(self):
        super().__init__("bulbscrew_gripper")
        defaults = {
            "gripper_command_topic": "/bulbscrew/gripper_width",
            "grasp_action": "/fr3_gripper/grasp",
            "move_action": "/fr3_gripper/move",
            "grip_max": 0.04,
            ...
            "speed": 0.1,
            "force": 20.0,
            "grasp_epsilon_inner": 0.05,
            "grasp_epsilon_outer": 0.05,
        ...
        if Grasp is not None:
            self.grasp = ActionClient(self, Grasp, g("grasp_action").value)
            self.move = ActionClient(self, Move, g("move_action").value)
        else:
